...
async def send_temperatures():
    while True:
        # Lees temperatuur- en lichtvariabelen
        ser_temp.write(b'1')
        ...
        # Verstuur temperatuur- en lichtwaarden naar Discord
        ...
        await client.get_channel(CHANNEL_SENSOR_3_TEMP).send(f"Lichtwaarde: {lichtwaarde}")
